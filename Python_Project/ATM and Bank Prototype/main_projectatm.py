...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        self.Canvas1 = tk.Canvas(window, background="goldenrod", borderwidth="0", insertbackground="black",
                                 relief="ridge",
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ececec",
                                 activeforeground="#000000", background="DodgerBlue4", disabledforeground="#a3a3a3",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="goldenrod", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="goldenrod",
                                foreground="#00254a",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="goldenrod",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
