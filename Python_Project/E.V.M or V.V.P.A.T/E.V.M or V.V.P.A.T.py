...
def win2():
    ...
    frame1 = tk.Frame(win2.window2, width=400, height=600, bg="#7B68EE")
    frame1.pack()

    label1 = tk.Label(win2.window2, text="V.V.P.A.T",width=14, relief=RIDGE, bg="yellow", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win2.window2, width=400, height=50, bg="#7B68EE")
    frame2.place(x=0, y=80)
    btn1 = tk.Button(frame2, text="Rate Us", width=10, relief=RAISED, borderwidth=5, bg="lime green",command=rating)
    ...
    frame3 = tk.Frame(win2.window2, width=400, height=400,relief=FLAT,borderwidth=9, bg="#7B68EE")
    frame3.place(x=0, y=133)
    btn4 = tk.Button(frame3, text="START\nVOTING", width=18, relief=RAISED, borderwidth=5, bg="#7FFFD4",command=win3)
...
def win3():
    ...
    frame1 = tk.Frame(win3.window3, width=400, height=600, bg="#7B68EE")
    frame1.pack()

    label1 = tk.Label(win3.window3, text="V.V.P.A.T",width=14, relief=RIDGE, bg="yellow", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win3.window3, width=400, height=50, bg="#7B68EE")
    frame2.place(x=0, y=60)
    btn1 = tk.Button(frame2, text="Rate Us", width=10, relief=RAISED, borderwidth=5, bg="lime green",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="hot pink",command=reset1)
    btn2.config(font=('Arial bold', 10))
    btn2.grid(row=0, column=2, padx=20)
    btn3 = tk.Button(frame2, text="Exit(X)", width=10, relief=RAISED, borderwidth=5, bg="red",command=exit1)
    btn3.config(font=('Arial bold', 10))
    ...
    frame5 = tk.Frame(win3.window3, width=400, height=400, relief=FLAT, borderwidth=9, bg="#7B68EE")
    ...
    btn8 = tk.Button(frame5, text="R.L.D", width=20, relief=RAISED, borderwidth=5, bg="#FF1493", command=rld)
    btn8.config(font=('Arial bold', 17))
    btn8.grid(row=1, column=0, padx=12, pady=2)
    btn9 = tk.Button(frame5, text="A.A.P", width=20, relief=RAISED, borderwidth=5, bg="blue", command=aap)
    btn9.config(font=('Arial bold', 17))
    btn9.grid(row=2, column=0, padx=12, pady=2)
    btn10 = tk.Button(frame5, text="B.S.P", width=20, relief=RAISED, borderwidth=5, bg="white", command=bsp)
    btn10.config(font=('Arial bold', 17))
    btn10.grid(row=3, column=0, padx=12, pady=2)
    btn11 = tk.Button(frame5, text="T.R.S", width=20, relief=RAISED, borderwidth=5, bg="#00FF00", command=trs)
    btn11.config(font=('Arial bold', 17))
    btn11.grid(row=4, column=0, padx=12, pady=2)

    frame4 = tk.Frame(win3.window3, width=400, height=400,relief=FLAT,borderwidth=9, bg="#7B68EE")
    ...
    btn5 = tk.Button(frame4, text="RESULT", width=8, relief=RAISED, borderwidth=5, bg="lime green",command=result)
    btn5.config(font=('Arial bold', 15))
    btn5.grid(row=1, column=0, padx=100,pady=5)
    btn6 = tk.Button(frame4, text="V.V.P.A.T", width=8, relief=RAISED, borderwidth=5, bg="red",command=history)
...
def win4():
    ...
    frame1 = tk.Frame(win4.window4, width=400, height=600, bg="#7B68EE")
    frame1.pack()

    label1 = tk.Label(win4.window4, text="V.V.P.A.T",width=14, relief=RIDGE, bg="yellow", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    ...
    frame5 = tk.Frame(win4.window4, width=400, height=400, relief=FLAT, borderwidth=9, bg="#7B68EE")
    ...
    label8 = tk.Label(frame5, text=a2, width=24, relief=RIDGE, borderwidth=5, bg="#FF1493")
    label8.config(font=('Arial bold', 15))
    label8.grid(row=1, column=0, padx=12, pady=6)
    label9 = tk.Label(frame5, text=a3, width=24, relief=RIDGE, borderwidth=5, bg="blue")
    label9.config(font=('Arial bold', 15))
    label9.grid(row=2, column=0, padx=12, pady=6)
    label10 = tk.Label(frame5, text=a4, width=24, relief=RIDGE, borderwidth=5, bg="white")
    label10.config(font=('Arial bold', 15))
    label10.grid(row=3, column=0, padx=12, pady=6)
    label11 = tk.Label(frame5, text=a5, width=24, relief=RIDGE, borderwidth=5, bg="#00FF00")
    label11.config(font=('Arial bold', 15))
    label11.grid(row=4, column=0, padx=12, pady=6)

    frame4 = tk.Frame(win4.window4, width=400, height=400,relief=FLAT,borderwidth=9, bg="#7B68EE")
    frame4.place(x=32, y=450)
    btn4 = tk.Button(frame4, text="COUNTING", width=9, relief=RAISED, borderwidth=5, bg="#00CED1",command=counting)
    btn4.config(font=('Arial bold', 15))
    btn4.grid(row=0, column=0, padx=100,pady=5)
